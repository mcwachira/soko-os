...
class UpdatePaymentVoucherRequest extends FormRequest
{
    ...
    {
        $voucherId = $this->route('payment-voucher');
        ...
        return [
            ...
            'voucher_number' => ['sometimes', 'string', 'max:50', Rule::unique('payment_vouchers', 'voucher_number')->where('organization_id', $this->user()->organization_id)->ignore($voucherId)],
            'supplier_id' => ['nullable', 'uuid', Rule::exists('suppliers', 'id')->where('organization_id', $this->user()->organization_id)],
            'currency' => ['nullable', 'string', 'max:3'],
            'gross_amount_minor' => ['nullable', 'integer', 'min:0'],
            ...
            'net_payable_minor' => ['nullable', 'integer', 'min:0'],
