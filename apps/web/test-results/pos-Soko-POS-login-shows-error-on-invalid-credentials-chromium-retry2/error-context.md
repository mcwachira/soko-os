...
- Name: pos.spec.ts >> Soko POS >> login shows error on invalid credentials
- Location: e2e/pos.spec.ts:23:7
...
Locator: getByText(/Login failed|Invalid credentials/)
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText(/Login failed|Invalid credentials/) with timeout 5000ms
  - waiting for getByText(/Login failed|Invalid credentials/)
...
- text: Email
- textbox "test@example.com": bad@example.com
- text: Password
