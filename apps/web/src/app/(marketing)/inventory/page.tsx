...
import { ArrowRight, Check, Wifi, WifiOff, RefreshCw, Shield, BarChart3, Package, CreditCard, Receipt, BookOpen, Globe, Truck, AlertTriangle, Clock, Save } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { productById } from '@/config/products';
import { countries } from '@/config/countries';
import DemoForm from '@/components/marketing/demo-form';

const product = productById('inventory');

export default function InventoryMarketingPage() {
  const productFaq = [
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Link href={`/login?redirect=/app/inventory`}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight">
              Stockouts cost you money. You need better visibility.
            </h2>
            <p className="mt-6 text-lg font-bold text-muted-foreground">
              Manual stock tracking leads to overstocking, stockouts, and expired products. Multi-branch visibility is nearly impossible without the right tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-foreground">
                Stock management that syncs automatically.
              </h2>
      ...
      <section className="border-b-4 border-black bg-secondary-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg font-bold text-muted-foreground">
              From receiving stock to reorder alerts.
            </p>
          </div>
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg font-bold text-foreground/80">
              {product.name} is designed to work fully offline. Your data is stored locally on your device and syncs automatically when you reconnect to the internet. Never miss a receipt or lose data due to connectivity.
            </p>
          </div>
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
